...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tiger_chat`.`CONVERSATION_CREATE_ID` BEFORE INSERT ON `CONVERSATION` FOR EACH ROW
BEGIN
	IF new.conversation_id = 'null' THEN
